 ...
 */
@Composable
fun HandleErrorView(networkError: Error) {
    ...
    when (networkError) {
        ...
        CustomRecipeErrorResponse.NO_NEW_ITEM -> {
            Toast.makeText(context, context.getText(R.string.reached_end_of_recipe_list), Toast.LENGTH_LONG)
                .show()
        }
